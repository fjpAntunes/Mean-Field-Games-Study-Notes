...
\subsection{Numerical Illustration}
        ...
        The model was simplified in order to achieve convergence with this algorithm. 
        Let's set 
    ...
    \begin{figure}[ht]
        ...
        \includegraphics[width=\textwidth]{qualificacao/model_proposal/simulations/simulations_mfg.png}
        }
